...
- The next gap is no longer “does the cross-app follow-up harness work at all,” or even “can `ui.swipe` be harnessed,” but “where is a higher-level preset or state-reset helper actually worth it without overfitting one OEM surface.” / 现在缺的已经不再是“cross-app follow-up harness 到底能不能工作”，甚至也不再是“`ui.swipe` 能不能接进 harness”，而是“哪里才真的值得补更高层的 preset 或状态重置 helper，同时又不至于过拟合某一台 OEM 设备的界面”。
