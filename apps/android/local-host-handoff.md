...
7. 如果要复跑第二个非 Settings 目标面，优先用 Calculator，而不是立刻新增第三个 preset：`OPENCLAW_ANDROID_LOCAL_HOST_TOKEN='<token>' OPENCLAW_ANDROID_LOCAL_HOST_UI_CROSS_APP_PACKAGE='com.coloros.calculator' OPENCLAW_ANDROID_LOCAL_HOST_UI_CROSS_APP_OBSERVE_WINDOW_MS='4000' ./apps/android/scripts/local-host-ui-cross-app-probe.sh`
