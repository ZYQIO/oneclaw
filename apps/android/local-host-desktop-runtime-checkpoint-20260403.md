...
- The new repeated-replay live active-session proof is both repo-verified and now freshly replayed on-device: on April 6, 2026 the same `PFEM10` phone reached `classification=process_runtime_active_session_live_proof_captured` on payload `0.17.0`.
