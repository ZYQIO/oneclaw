...
- `classification=process_runtime_active_session_validation_bootstrapped`: the branch now also leaves a structured active-session-validation artifact on disk, and the next step is to capture one real detached active-session proof on-device
