...
- `classification=process_runtime_detached_launch_bootstrapped`: the branch now also leaves a structured detached-launch-contract artifact on disk, and the next step is to execute that bootstrap through a real supervisor loop
