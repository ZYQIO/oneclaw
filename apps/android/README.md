...
- `classification=process_runtime_supervisor_loop_bootstrapped`: the branch now also leaves a structured supervisor-loop-contract artifact on disk, and the next step is to prove that bootstrap as a real detached active session on-device
