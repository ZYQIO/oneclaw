...
- `classification=process_runtime_active_session_bootstrapped`: the branch now also leaves a structured active-session-contract artifact on disk, and the next step is to prove that bootstrap as a real detached active session on-device
